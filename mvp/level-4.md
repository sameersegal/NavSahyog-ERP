...
| Sub | Scope | Status |
|---|---|---|
| L4.0 | Offline platform — versioned generic outbox, IDB migration framework, service-worker upgrade, build-id pinning, additive-only CI guard, sync-state taxonomy. **No new offline workflows ship in this slice.** | not started |

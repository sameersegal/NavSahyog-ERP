...
Status: **complete draft v1**. Written in 5 parts (see `HANDOFF.md`).
All 11 sections present. Open items are collected at the end of
each section and consolidated in §11.11.
